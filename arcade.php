        ...
        <div class="arcade-screen-container global-crt-filter">
            <div class="arcade-fs-layout">
                ...
                <div class="arcade-menu-list" role="listbox" aria-label="<?php echo $labels['arcade_select_game']; ?>">
                    ...
                    <div class="arcade-menu-item" data-game="stack" data-title="STACK OVERFLOW" data-color="#00d9ff" data-desc="<?php echo $labels['arcade_desc_stack']; ?>" role="option" tabindex="-1" aria-selected="false" aria-label="Stack Overflow — <?php echo $labels['arcade_g_stack_short']; ?>">
                        <span class="item-num">07</span>
                        <div class="item-info"><span class="item-name">STACK OVERFLOW</span><span class="item-desc"><?php echo $labels['arcade_g_stack_short']; ?></span></div>
                    </div>
...
<script>window.APP_LANG='<?php echo $lang; ?>';window.ARCADE_TXT={loading:"<?php echo $labels["arcade_loading"]; ?>",gameUnavailable:"<?php echo $labels["arcade_game_unavailable"]; ?>",score:"<?php echo $labels["arcade_go_score"]; ?>",record:"<?php echo $labels["arcade_go_record"]; ?>",returnRetry:"<?php echo $labels["arcade_go_return_retry"]; ?>",returnMenu:"<?php echo $labels["arcade_go_return"]; ?>",points:"<?php echo $labels['arcade_hud_points']; ?>",life:"<?php echo $labels['arcade_hud_life']; ?>",lives:"<?php echo $labels['arcade_hud_lives']; ?>",wave:"<?php echo $labels['arcade_hud_wave']; ?>",loop:"<?php echo $labels['arcade_hud_loop']; ?>",fireFlower:"<?php echo $labels['arcade_fire_flower']; ?>",connecting:"<?php echo $labels['arcade_connecting']; ?>",connectingSub:"<?php echo $labels['arcade_connecting_sub']; ?>",loadingPhase:"<?php echo $labels['arcade_loading_phase']; ?>",hint:{move:"<?php echo $labels['arcade_hint_move']; ?>",moveSnake:"<?php echo $labels['arcade_hint_move_snake']; ?>",moveShip:"<?php echo $labels['arcade_hint_move_ship']; ?>",fire:"<?php echo $labels['arcade_hint_fire']; ?>",rotate:"<?php echo $labels['arcade_hint_rotate']; ?>",thrust:"<?php echo $labels['arcade_hint_thrust']; ?>",run:"<?php echo $labels['arcade_hint_run']; ?>",jump:"<?php echo $labels['arcade_hint_jump']; ?>",crouch:"<?php echo $labels['arcade_hint_crouch']; ?>",fireball:"<?php echo $labels['arcade_hint_fireball']; ?>",space:"<?php echo $labels['arcade_hint_space']; ?>",stuck:"<?php echo $labels['arcade_hint_stuck']; ?>",softDrop:"<?php echo $labels['arcade_hint_soft_drop']; ?>",hardDrop:"<?php echo $labels['arcade_hint_hard_drop']; ?>",squash:"<?php echo $labels['arcade_hint_squash']; ?>"},stackTagline:"<?php echo $labels['arcade_stack_tagline']; ?>",stackBugHint:"<?php echo $labels['arcade_stack_bug_hint']; ?>",stackLevel:"<?php echo $labels['arcade_stack_level']; ?>",stackLines:"<?php echo $labels['arcade_stack_lines']; ?>",stackBugs:"<?php echo $labels['arcade_stack_bugs']; ?>",stackBugsShort:"<?php echo $labels['arcade_stack_bugs_short']; ?>",stackNext:"<?php echo $labels['arcade_stack_next']; ?>",stackDebt:"<?php echo $labels['arcade_stack_debt']; ?>",stackPiecesLeft:"<?php echo $labels['arcade_stack_pieces_left']; ?>",backToMenu:"<?php echo $labels['arcade_go_return']; ?>",start:"<?php echo $labels['arcade_start_mission']; ?>"};</script>
