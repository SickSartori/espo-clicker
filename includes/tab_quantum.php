<div id="quantum-wrapper" class="tab-content" style="display: none;">
    <div id="quantum-store" style="display: block;">
        ...
        <div style="background: rgba(155, 89, 182, 0.1); border: 2px solid rgba(155, 89, 182, 0.4); border-radius: 8px; padding: 15px; margin: 10px 15px 25px 15px; text-align: center;">
            <h3 style="color: #e74c3c; margin: 0 0 10px 0; font-size: 1.1rem;"><i class="fa-solid fa-triangle-exclamation"></i> RIAVVIO UNIVERSO</h3>
            <p style="color: #bdc3c7; font-size: 0.8rem; margin-bottom: 10px;">Distruggi questo universo (reset Bug, Teams, Lab e Token). Conserverai Skin, Obiettivi e Statistiche globali.</p>
        ...
        <div class="section-header">
            <h2 style="color: #9b59b6; font-size: 0.9rem;"><i class="fa-solid fa-microchip"></i> Meta-Tecnologie</h2>
        </div>
        ...
        <div id="quantum-empty" class="empty-state-msg" style="display: none;">
			Tutte le tecnologie quantiche sono state ricercate.
        </div>
    </div>
</div>