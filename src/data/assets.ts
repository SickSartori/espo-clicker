export const assets: Record<string, any> = {
    sounds: {
        ...
        'bg-music-jazz': {
            id: 'sound-bg-music-jazz',
            file: 'assets/sounds/music/bg-music-jazz.mp3',
        ...
        // I file sono stati normalizzati a ~-23.9 LUFS, lo stesso livello di
        // sound-arcade-start: prima la forbice fra loro era di 32 dB (star-collect
        // a -4.9 LUFS con picco oltre il fondo scala, goomba-stomp a -36.6).
        // Ora che sono uniformi, defaultVol esprime solo l'intento di design:
        // piu' basso cio' che suona di continuo, piu' alto cio' che e' un evento.
        // Il gameover di Super Espo NON e' qui: e' lo stesso identico file di
        // sound-arcade-gameover (md5 uguale, condiviso con altri 4 giochi) e ne
        // riusa la voce, cosi' resta un solo cursore per un solo suono.
        'espo-jump': {
            id: 'sound-espo-jump',
            ...
            category: 'effetti',
            preload: false,
            defaultVol: 0.13   // a ogni salto e a ogni fireball: il piu' frequente
        },
        'espo-coin': {
            id: 'sound-espo-coin',
        ...
        'espo-stomp': {
            ...
            name: 'Super Espò · Impatto',
            type: 'sfx',
            category: 'effetti',
            preload: false,
            defaultVol: 0.30   // nemici schiacciati, blocchi rotti, colpi di guscio
        },
        'espo-star-appears': {
            id: 'sound-espo-star-appears',
            file: 'assets/sounds/arcade/super-espo/star-appears.mp3',
            name: 'Super Espò · Power-up appare',
            type: 'sfx',
            category: 'effetti',
            preload: false,
            defaultVol: 0.35   // comparsa di fungo, stella o fiore di fuoco
        },
        'espo-star-collect': {
            id: 'sound-espo-star-collect',
            file: 'assets/sounds/arcade/super-espo/star-collect.mp3',
            name: 'Super Espò · Power-up preso',
            type: 'sfx',
            category: 'effetti',
            preload: false,
            defaultVol: 0.45   // raccolta di fungo, stella o fiore: momento premiante
        },
        'snowball': {
            id: 'sound-snowball',
        ...
        'intro-typing': {
            ...
            file: 'assets/sounds/intro/intro-typing.mp3',
            name: 'Intro Typing',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.45
        ...
        'intro-glitch': {
            ...
            file: 'assets/sounds/intro/intro-glitch.mp3',
            name: 'Intro Glitch',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.55
        ...
        'intro-scan': {
            id: 'sound-intro-scan',
            file: 'assets/sounds/intro/intro-scan.mp3',
            name: 'Intro Scanner',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.45
        ...
        'intro-fixed': {
            ...
            file: 'assets/sounds/intro/intro-fixed.mp3',
            name: 'Intro Fixed',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.5
        ...
        'intro-reveal': {
            ...
            file: 'assets/sounds/intro/intro-reveal.mp3',
            name: 'Intro Reveal',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.6
        ...
        'esposion-tick': {
            ...
            file: 'assets/sounds/esposion/esposion-tick.mp3',
            name: 'Esposion Tick',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.4
        ...
        'esposion-charge': {
            ...
            file: 'assets/sounds/esposion/esposion-charge.mp3',
        ...
        'esposion-boom': {
            ...
            file: 'assets/sounds/esposion/esposion-boom.mp3',
            name: 'Esposion Boom',
            type: 'sfx',
            category: 'effetti',
            defaultVol: 0.6
        ...
        'esposion-crackle': {
            ...
            file: 'assets/sounds/esposion/esposion-crackle.mp3',
